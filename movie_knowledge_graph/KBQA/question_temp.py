...
模块 REfO 实现的知识库问答初级系统. 该问答系统可以解析输入的自然语言问句生成 SPARQL 查询，进一步请求后台基于 TDB 知识库的 Apache Jena Fuseki 服务, 得到结果
REfO(Regular Expressions for Objects)来完成语义匹配


设置问题模板，为每个模板设置对应的SPARQL语句,这称之为KBQA。demo提供如下模板：
